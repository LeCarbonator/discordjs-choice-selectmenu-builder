...
var ChoiceSelectMenuBuilder = class _ChoiceSelectMenuBuilder {
  ...
  get navigatorButtons() {
    ...
    return new ActionRowBuilder().addComponents(
      new ButtonBuilder().setLabel("\u23EE\uFE0F").setStyle(buttonStyles.navigator).setDisabled(isAtStart).setCustomId(`${customId}--firstPage`),
      new ButtonBuilder().setLabel("\u25C0\uFE0F").setStyle(buttonStyles.navigator).setDisabled(isAtStart).setCustomId(`${customId}--prevPage`),
      // The center button displays what page you're currently on.
      new ButtonBuilder().setLabel(`Page ${page.current + 1}/${page.max + 1}`).setStyle(buttonStyles.middle).setDisabled(true).setCustomId("btn-never"),
      new ButtonBuilder().setLabel("\u25B6\uFE0F").setStyle(buttonStyles.navigator).setDisabled(isAtEnd).setCustomId(`${customId}--nextPage`),
      new ButtonBuilder().setLabel("\u23ED\uFE0F").setStyle(buttonStyles.navigator).setDisabled(isAtEnd).setCustomId(`${customId}--lastPage`)
    );
  }
};
export {
